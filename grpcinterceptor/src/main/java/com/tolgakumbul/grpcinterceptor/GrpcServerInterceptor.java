package com.tolgakumbul.grpcinterceptor;
...
public class GrpcServerInterceptor implements ServerInterceptor {
    ...
    private static final String GUID_HEADER = "Guid";
    ...
    public <ReqT, RespT> ServerCall.Listener<ReqT> interceptCall(ServerCall<ReqT, RespT> call, Metadata headers, ServerCallHandler<ReqT, RespT> next) {
        ...
        String authToken = headers.get(Metadata.Key.of(AUTHORIZATION_HEADER, Metadata.ASCII_STRING_MARSHALLER));
        String guid = headers.get(Metadata.Key.of(GUID_HEADER, Metadata.ASCII_STRING_MARSHALLER));
