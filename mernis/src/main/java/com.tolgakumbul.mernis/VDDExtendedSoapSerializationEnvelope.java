...
class VDDSoapFaultEx extends org.ksoap2.SoapFault {
    public Object fault;
}
...
public class VDDExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VDDDateTimeConverter converter) {
        if (converter == null) {
            converter = new VDDStandardDateTimeConverter();
        }
        dateTimeConverter = converter;
    }

    public static VDDDateTimeConverter getDateTimeConverter() {
        return dateTimeConverter;
    }

    private static VDDDateTimeConverter dateTimeConverter = new VDDStandardDateTimeConverter();

    public VDDExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VDDExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VDDMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null) {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector) && type.type != java.lang.String.class)) {
                java.lang.String xmlName = VDDHelper.getKeyByValue(classNames, obj.getClass());
                if (xmlName != null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap", Object.class, VDDExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param) {
        ...
        java.lang.String xmlName = VDDHelper.getKeyByValue(classNames, obj);
        if (xmlName == null) {
            return obj;
        }
        return xmlName;
