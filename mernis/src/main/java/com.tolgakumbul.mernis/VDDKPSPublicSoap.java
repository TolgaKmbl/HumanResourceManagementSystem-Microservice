...
public class VDDKPSPublicSoap
{
    ...
    public VDDKPSPublicSoap(){}

    public VDDKPSPublicSoap (VDDIServiceEvents callback)
    {
        this.callback = callback;
    }
    public VDDKPSPublicSoap(VDDIServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public VDDKPSPublicSoap(VDDIServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    {
        VDDExtendedSoapSerializationEnvelope envelope= new VDDExtendedSoapSerializationEnvelope(VDDExtendedSoapSerializationEnvelope.VER11);
