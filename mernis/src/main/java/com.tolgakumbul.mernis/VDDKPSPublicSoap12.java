...
public class VDDKPSPublicSoap12
{
    interface VDDIWcfMethod
    {
        VDDExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(VDDExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public VDDKPSPublicSoap12(){}

    public VDDKPSPublicSoap12 (VDDIServiceEvents callback)
    {
        this.callback = callback;
    }
    public VDDKPSPublicSoap12(VDDIServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public VDDKPSPublicSoap12(VDDIServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    protected VDDExtendedSoapSerializationEnvelope createEnvelope()
    {
        VDDExtendedSoapSerializationEnvelope envelope= new VDDExtendedSoapSerializationEnvelope(VDDExtendedSoapSerializationEnvelope.VER12);
        envelope.setEnableLogging( enableLogging);
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,VDDExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,VDDExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new VDDIWcfMethod()
        {
            @Override
            public VDDExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                VDDExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(VDDExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(VDDIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        VDDExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,VDDExtendedSoapSerializationEnvelope envelope)
    {
